...
.start-sec .main-sec .left .txt12  {
    text-align: left;
}

.start-sec .main-sec .left .btn1 input {
    padding: 10px 30px;
    border: none;
    background-color: white;
    cursor: pointer;
...
<section class="loc-sec">
    <div class="main-sec">
        ...
        <!-- Search Button -->
        <div class="pick">
            <input type="button" value="Search Car" onclick="window.location.href='customer_view_cars.jsp'" > 
        </div>
    </div>
</section>

   <jsp:include page="customer_home_view_cars.jsp"/>
    <! Achieve section !>
